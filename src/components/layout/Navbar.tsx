...
export const Navbar: React.FC<NavbarProps> = ({ onToggleSidebar }) => {
  const { currentUser, currentRole, profile, notifications, markNotificationRead, logout, switchRole } = useAuth();
  ...
  return (
    <header className="bg-[#f8f6f0]/90 border-b border-[#e5e0d5] backdrop-blur-xl sticky top-0 z-40">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between gap-4">
        ...
        {/* Center: Search Bar & Demo Persona Switcher */}
        <div className="hidden md:flex flex-1 items-center justify-center gap-3 max-w-xl mx-2">
          {/* Demo Persona Role Switcher */}
          <div className="hidden lg:flex items-center gap-1 bg-[#f0ede6] border border-[#e5e0d5] p-1 rounded-xl shadow-2xs">
