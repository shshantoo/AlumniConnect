...
export const AICareerCoachModal: React.FC<AICareerCoachModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 bg-zinc-950/60 backdrop-blur-sm z-50 flex items-center justify-center p-3 sm:p-6 overflow-y-auto">
      <div className="bg-white rounded-3xl p-5 sm:p-8 max-w-xl w-full my-auto space-y-5 shadow-2xl relative overflow-hidden max-h-[90vh] flex flex-col">
        {/* Decorative backdrop */}
        <div className="absolute top-0 right-0 w-64 h-64 bg-amber-500/10 rounded-full blur-3xl -mr-16 -mt-16 pointer-events-none" />

        {/* Header */}
        <div className="flex items-center justify-between border-b border-zinc-100 pb-3 relative z-10 shrink-0">
        ...
        {/* Footer */}
        <div className="flex justify-end pt-3 border-t border-zinc-100 relative z-10 shrink-0">
          <button
            onClick={onClose}
