...
export const AICVAnalyzerModal: React.FC<AICVAnalyzerModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 bg-zinc-950/60 backdrop-blur-sm z-50 flex items-center justify-center p-3 sm:p-6 overflow-y-auto">
      <div className="bg-white rounded-3xl p-5 sm:p-8 max-w-2xl w-full my-auto space-y-5 shadow-2xl relative overflow-hidden max-h-[90vh] flex flex-col">
        {/* Header */}
        <div className="flex items-center justify-between border-b border-zinc-100 pb-3 shrink-0">
          ...
          <button onClick={onClose} className="text-zinc-400 hover:text-zinc-800 font-bold text-lg p-1">
            ✕
          </button>
        </div>
            ...
            <div className="space-y-5 text-xs">
              ...
              <div className="space-y-4">
                ...
                {analysis.suggestions.map((sug) => {
                  ...
                  return (
                    <div key={sug.section} className="bg-zinc-50 border border-zinc-200 rounded-2xl p-4 space-y-3">
